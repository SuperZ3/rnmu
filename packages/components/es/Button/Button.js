...
const Button = (props) => {
  ...
  const Touchable = interactionEffect === "highlight" ? TouchableOpacity : Ripple;
  return /* @__PURE__ */ React.createElement(
    ...
    loading && /* @__PURE__ */ React.createElement(
      ...
      loadingIcon || /* @__PURE__ */ React.createElement(ActivityIndicator, { style: { width: 18, height: 18, margin: 0 } })
    ),
